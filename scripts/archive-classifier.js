(function (root, factory) {
  ...
  var CATEGORIES = [
    { id: 'ai', label: 'AI', icon: '🤖', hosts: ['openai.com', 'platform.openai.com', 'chatgpt.com', 'chat.openai.com', 'anthropic.com', 'claude.ai', 'gemini.google.com', 'bard.google.com', 'copilot.microsoft.com', 'huggingface.co', 'perplexity.ai', 'poe.com', 'character.ai', 'midjourney.com', 'stability.ai', 'replicate.com', 'cohere.com', 'mistral.ai', 'groq.com', 'kimi.moonshot.cn', 'doubao.com', 'tongyi.aliyun.com', 'yiyan.baidu.com'], keywords: ['openai', 'chatgpt', 'gpt-4', 'gpt-3', 'Muse', 'gemini', 'copilot', 'llm', 'huggingface', 'perplexity', 'midjourney', 'stable-diffusion', 'stability', 'langchain', 'prompt'], titleKeywords: ['openai', 'chatgpt', 'gpt', 'Muse', 'gemini', 'copilot', 'llm', 'huggingface', 'perplexity', 'midjourney', '机器学习', '人工智能', '大模型'], pathHints: ['/gpt/', '/llm/', '/ai/'] },
    { id: 'dev', label: 'Dev', icon: '💻', hosts: ['github.com', 'gist.github.com', 'gitlab.com', 'bitbucket.org', 'stackoverflow.com', 'stackexchange.com', 'npmjs.com', 'pypi.org', 'crates.io', 'pkg.go.dev', 'developer.mozilla.org', 'dev.to', 'codepen.io', 'jsfiddle.net', 'docker.com', 'hub.docker.com', 'kubernetes.io', 'gitbook.io', 'vercel.app', 'netlify.app', 'cloudflare.com', 'digitalocean.com', 'aws.amazon.com', 'azure.microsoft.com', 'gitee.com', 'csdn.net', 'juejin.cn', 'segmentfault.com'], keywords: ['github', 'gitlab', 'stackoverflow', 'npm', 'pip', 'docker', 'kubernetes', 'api', 'sdk', 'pull-request', 'commit'], titleKeywords: ['github', 'gitlab', 'stackoverflow', 'npm', 'docker', 'kubernetes', 'api', 'sdk', '代码', '开源', '编程', '开发', '程序'], pathHints: ['/pull/', '/issues/', '/commit/', '/blob/', '/tree/', '/api/', '/sdk/', '/npm/', '/github/'] },
    { id: 'docs', label: 'Docs', icon: '📄', hosts: ['readthedocs.io', 'readthedocs.org', 'gitbook.io', 'notion.site', 'docs.python.org', 'docs.rs', 'hexdocs.pm', 'godoc.org', 'confluence.atlassian.com', 'wiki.archlinux.org', 'wikipedia.org', 'zh.wikipedia.org', 'baike.baidu.com'], keywords: ['readthedocs', 'gitbook', 'confluence', 'wiki'], titleKeywords: ['documentation', 'handbook', 'manual', 'reference', 'wiki', '文档', '手册', '百科', '说明'], pathHints: ['/docs/', '/documentation/', '/wiki/', '/manual/', '/handbook/', '/reference/', '/guide/'] },
    { id: 'design', label: 'Design', icon: '🎨', hosts: ['dribbble.com', 'behance.net', 'figma.com', 'sketch.com', 'canva.com', 'adobe.com', 'pinterest.com', 'huaban.com', 'zcool.com.cn'], keywords: ['dribbble', 'behance', 'figma', 'sketch', 'canva', 'photoshop'], titleKeywords: ['design', 'figma', 'dribbble', 'behance', 'ui', 'ux', '设计'], pathHints: ['/design/', '/dribbble/', '/behance/'] },
    { id: 'video', label: 'Video', icon: '🎬', hosts: ['youtube.com', 'youtu.be', 'vimeo.com', 'netflix.com', 'twitch.tv', 'bilibili.com', 'youku.com', 'iqiyi.com', 'v.qq.com', 'mgtv.com', 'douyin.com', 'acfun.cn'], keywords: ['youtube', 'vimeo', 'netflix', 'twitch', 'bilibili', 'youku', 'iqiyi'], titleKeywords: ['video', 'youtube', 'vimeo', 'watch', 'live', '视频', '电影', '观看'], pathHints: ['/watch', '/video/', '/embed/', '/live/', '/play/'] },
    { id: 'audio', label: 'Audio', icon: '🎧', hosts: ['xiaoyuzhoufm.com', 'spotify.com', 'open.spotify.com', 'music.apple.com', 'podcasts.apple.com', 'soundcloud.com', 'music.youtube.com', 'music.163.com', 'y.qq.com', 'kugou.com', 'kuwo.cn', 'ximalaya.com', 'lizhi.fm', 'podcasts.google.com', 'douban.fm'], keywords: ['spotify', 'soundcloud', 'podcast', 'xiaoyuzhou', 'ximalaya', 'fm'], titleKeywords: ['podcast', 'audio', 'music', 'episode', 'spotify', 'soundcloud', '播客', '音乐', '电台', '节目'], pathHints: ['/episode/', '/podcast/', '/audio/', '/music/', '/fm/'] },
    { id: 'news', label: 'News', icon: '📰', hosts: ['bbc.com', 'bbc.co.uk', 'cnn.com', 'nytimes.com', 'theguardian.com', 'reuters.com', 'bloomberg.com', 'thepaper.cn', 'sina.com.cn', 'news.sina.com.cn', 'sohu.com', 'news.sohu.com', 'ifeng.com', 'toutiao.com', 'qq.com', 'news.qq.com', '163.com', 'news.163.com', 'huxiu.com', '36kr.com'], keywords: ['bbc', 'cnn', 'reuters', 'bloomberg', 'guardian'], titleKeywords: ['news', 'breaking', 'headline', 'report', '新闻', '资讯', '报道', '头条', '快讯'], pathHints: ['/news/', '/article/', '/story/', '/post/', '/a/'] },
    { id: 'social', label: 'Social', icon: '💬', hosts: ['twitter.com', 'x.com', 'facebook.com', 'instagram.com', 'linkedin.com', 'reddit.com', 'weibo.com', 'zhihu.com', 'douban.com', 'tieba.baidu.com', 't.me', 'telegram.me', 'discord.com', 'slack.com', 'threads.net', 'mastodon.social'], keywords: ['twitter', 'facebook', 'instagram', 'reddit', 'weibo', 'zhihu', 'douban', 'tieba', 'tweet'], titleKeywords: ['tweet', 'reddit', 'weibo', 'zhihu', 'douban', 'post', 'thread', '微博', '知乎', '豆瓣', '贴吧', '社交'], pathHints: ['/status/', '/r/', '/u/', '/user/', '/p/'] },
    { id: 'edu', label: 'Edu', icon: '🎓', hosts: ['coursera.org', 'edx.org', 'udemy.com', 'khanacademy.org', 'w3schools.com', 'runoob.com', 'liaoxuefeng.com', 'imooc.com', 'study.163.com', 'ke.qq.com', 'mit.edu', 'stanford.edu', 'harvard.edu', 'icourse163.org', 'bilibili.com'], keywords: ['coursera', 'udemy', 'edx', 'khan', 'course', 'lecture', 'mooc'], titleKeywords: ['course', 'lecture', 'lesson', 'learn', 'study', 'mooc', '课程', '学习', '教育', '课堂', '教程指南'], pathHints: ['/course/', '/learn/', '/lecture/', '/lesson/', '/tutorial/', '/edu/'] },
    { id: 'shopping', label: 'Shopping', icon: '🛒', hosts: ['amazon.com', 'amazon.cn', 'ebay.com', 'taobao.com', 'tmall.com', 'jd.com', 'pinduoduo.com', 'pdd.com', 'suning.com', 'dangdang.com', 'smzdm.com', 'dewu.com', 'vip.com', '1688.com', 'aliexpress.com'], keywords: ['amazon', 'ebay', 'taobao', 'tmall', 'jd.com', 'smzdm', 'aliexpress'], titleKeywords: ['shop', 'buy', 'deal', 'discount', 'coupon', '购物', '淘宝', '京东', '优惠', '值得买', '拼多多'], pathHints: ['/product/', '/item/', '/dp/', '/buy/', '/cart/', '/order/', '/goods/'] },
    { id: 'office', label: 'Office', icon: '📊', hosts: ['docs.google.com', 'drive.google.com', 'mail.google.com', 'office.com', 'outlook.live.com', 'onedrive.live.com', 'dropbox.com', 'notion.so', 'feishu.cn', 'dingtalk.com', 'docs.qq.com', 'docs.feishu.cn', 'pan.baidu.com', 'aliyundrive.com'], keywords: ['gmail', 'outlook', 'notion', 'dropbox', 'onedrive', 'feishu', 'dingtalk', 'spreadsheet'], titleKeywords: ['sheet', 'office', 'notion', 'drive', 'email', 'slide', '表格', '文档办公', '邮箱', '会议'], pathHints: ['/docs/', '/sheets/', '/drive/', '/mail/', '/calendar/', '/meeting/'] },
    { id: 'game', label: 'Game', icon: '🎮', hosts: ['store.steampowered.com', 'steampowered.com', 'epicgames.com', 'ign.com', 'gamespot.com', 'nintendo.com', 'playstation.com', 'xbox.com', '4399.com', '7k7k.com', 'gameres.com', '3dmgame.com', 'ali213.net'], keywords: ['steam', 'epicgames', 'nintendo', 'playstation', 'xbox', 'ign'], titleKeywords: ['game', 'gaming', 'steam', 'playstation', 'xbox', '游戏', '电竞'], pathHints: ['/game/', '/games/', '/play/'] },
    { id: 'finance', label: 'Finance', icon: '💰', hosts: ['paypal.com', 'stripe.com', 'alipay.com', 'bankofamerica.com', 'chase.com', 'icbc.com.cn', 'ccb.com', 'abchina.com', 'bankcomm.com', 'xueqiu.com', 'eastmoney.com', '10jqka.com.cn', 'futu5.com', 'tigerbrokers.com'], keywords: ['paypal', 'stripe', 'alipay', 'bank', 'stock', 'fund'], titleKeywords: ['bank', 'finance', 'stock', 'investment', 'fund', 'pay', '银行', '金融', '股票', '基金', '理财', '支付'], pathHints: ['/finance/', '/bank/', '/pay/', '/stock/', '/fund/', '/quote/'] },
    { id: 'travel', label: 'Travel', icon: '✈️', hosts: ['booking.com', 'expedia.com', 'trip.com', 'ctrip.com', 'qunar.com', 'airbnb.com', 'maps.google.com', 'amap.com', 'map.baidu.com', '12306.cn', 'fliggy.com', 'mafengwo.cn', 'dianping.com'], keywords: ['booking', 'expedia', 'airbnb', 'ctrip', 'trip.com', 'qunar'], titleKeywords: ['travel', 'hotel', 'flight', 'booking', 'trip', '旅游', '酒店', '机票', '攻略', '出行'], pathHints: ['/hotel/', '/flight/', '/travel/', '/booking/', '/trip/'] },
    { id: 'other', label: 'Other', icon: '📦', hosts: [], keywords: [], titleKeywords: [], pathHints: [] }
  ];
  ...
  function classifyAll(bookmarks, options) {
    ...
    for (var gi = 0; gi < CATEGORIES.length; gi++) {
      ...
      if (items && items.length) groups.push({ category: cat.id, label: cat.label, icon: cat.icon, items: items });
    }
    return {
      groups: groups,
      stats: {
